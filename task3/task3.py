...
class EncoderRNN(nn.Module):
    def __init__(self, input_size,embedding_size, hidden_size):
        ...
        self.gru = nn.Sequential(
                        nn.GRU(embedding_size, hidden_size,batch_first=True,num_layers=1,bidirectional=False)
                    )
...
if __name__ == '__main__':
    ...
    # encoder.load_state_dict(torch.load('task3_encoder_v3.pkl'))
    # decoder.load_state_dict(torch.load('task3_decoder_v3.pkl'))
    ...
    for epoch in range(15000):
        ...
        torch.save(encoder.state_dict(), 'task3_encoder_v3'+'.pkl')
        torch.save(decoder.state_dict(), 'task3_decoder_v3'+'.pkl')
